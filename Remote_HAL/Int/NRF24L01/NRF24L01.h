...
#define NRF24L01_CSN_HIGH HAL_GPIO_WritePin(SPI1_NSS_GPIO_Port, SPI1_NSS_Pin, GPIO_PIN_SET) // 片选拉高
#define NRF24L01_CSN_LOW HAL_GPIO_WritePin(SPI1_NSS_GPIO_Port, SPI1_NSS_Pin, GPIO_PIN_RESET) // 片选拉低
#define NRF24L01_CE_HIGH HAL_GPIO_WritePin(SI_EN_GPIO_Port, SI_EN_Pin, GPIO_PIN_SET) // 芯片失能
#define NRF24L01_CE_LOW HAL_GPIO_WritePin(SI_EN_GPIO_Port, SI_EN_Pin, GPIO_PIN_RESET) // 芯片使能
...
#define SPI_WRITE_REG   0x20  //写配置寄存器,低5位为寄存器地址  (001A AAAA)
